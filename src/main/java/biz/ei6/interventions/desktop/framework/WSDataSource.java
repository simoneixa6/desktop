...
import biz.ei6.interventions.desktop.lib.domain.InterventionDTO;
...
public class WSDataSource implements InterventionsDataSource {
    ...
    public void add(Intervention intervention) {
        ...
        try {
            ...
            InterventionDTO objInterventionDTO = new InterventionDTO();
            objInterventionDTO.setInterventionDTO(intervention);
            
            ObjectMapper om = new ObjectMapper();
            
            var data = om.writeValueAsString(objInterventionDTO);
